...
public class EmployeesController(EmployeeService employeeService) : ControllerBase
{
    ...
    {
        return Ok(ApiResponseFactory.Success(await employeeService.GetAllAsync(new PageRequest(pageNumber, pageSize))));
    }
    ...
    public async Task<IActionResult> CreateEmployee([FromBody] CreateEmployeeDto dto)
    {
        ...
        return CreatedAtAction(nameof(GetEmployee), new { id = created.EmployeeId },
    ...
    {
        return Ok(ApiResponseFactory.Success(await employeeService.UpdateEmployee(id, dto)));
    }
    ...
    {
        return Ok(ApiResponseFactory.Success(await employeeService.GrantAdminRole(id)));
    }
